...
def generate_data(im_path):
    ...
    with open(txt_path, 'r') as f:
      points = np.array([[float(line.split(' ')[0]), float(line.split(' ')[1])] for line in f], dtype=np.float32)
...
def parse_args():
    ...
    parser.add_argument('--origin-dir', default='/content/Bayesian-Crowd-Counting/datasets/jhu_crowd_v2.0',
                        help='original data directory')
    parser.add_argument('--data-dir', default='/content/Bayesian-Crowd-Counting/preprocessed',
